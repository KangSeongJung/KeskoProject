                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">계정을 생성하세요!</h1>
                            </div>
                            <form class="user">
                                ...
                                <a href="index.jsp" class="btn btn-google btn-user btn-block">
                                    <i class="fab fa-google fa-fw"></i> Google로 등록하기
                                </a>
                                <a href="index.jsp" class="btn btn-facebook btn-user btn-block">
                                    <i class="fab fa-facebook-f fa-fw"></i> Facebook으로 등록하기
                                </a>
                            </form>
                            <hr>
                            <div class="text-center">
                            ...
                            <div class="text-center">
                                <a class="small" href="login.jsp">이미 계정이 있으시다면, 다시 로그인해주세요.</a>
                            </div>
                        </div>
                    </div>
                </div>
