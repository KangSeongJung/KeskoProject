    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../admin/index.jsp">
                ...
                <div class="sidebar-brand-text mx-3">kesko</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../admin/buttons.jsp">Buttons</a>
                        <a class="collapse-item" href="../admin/cards.jsp">Cards</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../admin/utilities-color.jsp">Colors</a>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="../freeboard/adminfreelist.do">
										      	...
										      	<div class="col-lg-6 col-xl-4">
						                       		<div class="card mb-5 mb-xl-0">
						                           		<div class="card-body p-5">
						                               		...
						                               		<div class="d-grid"><a class="btn btn-outline-primary" href="../kesboard/adminview.do?idx=${row.idx}">바로 가기</a></div>
						                           		</div>
						                       		</div>
						                   		</div>
										</c:forEach>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
							        <tr align="center">
							            ...
							            <td width="100"><button type="button"
							                onclick="location.href='../kesboard/adminwrite.do';">글쓰기</button></td>
							        </tr>
							    </table>
        </div>
    </div>
