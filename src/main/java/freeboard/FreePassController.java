...
public class FreePassController extends HttpServlet{
	
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.setAttribute("mode", req.getParameter("mode"));
		req.getRequestDispatcher("/Keskomain/freeboard/freepass.jsp").forward(req, resp);		
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(confirmed) {
			...
			if(mode.equals("edit")) {
				...
				resp.sendRedirect("../freeboard/freeedit.do?idx="+idx);
			}
				...
				JSFunction.alertLocation(resp, "삭제되었습니다.", "../freeboard/freelist.do");
			}
		}
		else {
